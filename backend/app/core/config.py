...
class Settings:
    ...
    # ==================== Invest: инвестиционный раздел ====================
    # Сид для детерминированного «рынка» (цены/стакан). Пусто = недетерминированно
    # (цены всё равно плавные, но у разных стендов свои). Задайте одинаковый сид,
    # чтобы автотесты видели воспроизводимые котировки.
    invest_seed: str = os.getenv("INVEST_SEED", "")
